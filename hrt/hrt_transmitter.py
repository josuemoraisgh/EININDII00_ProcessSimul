...
class HrtTransmitter:
    ...
    def _response(self, hrt_data, hrt_frame_read):
        ...
        if command == '00':  # Identity Command
            ...
            self._hrt_frame_write.body += f"{hrt_data.get_variable('master_address | manufacturer_id')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('device_type')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('request_preambles')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('hart_revision')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('software_revision')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('transmitter_revision')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('hardware_revision')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('device_flags')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('device_id')}"
        elif command == '01':  # Read Primary Variable
            self._hrt_frame_write.body = f"{hrt_data.get_variable('error_code')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('unit_code')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('PROCESS_VARIABLE')}"
        elif command == '02':  # Read Loop Current And Percent Of Range
            self._hrt_frame_write.body = f"{hrt_data.get_variable('error_code')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('loop_current')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('percent_of_range')}"
        elif command == '03':  # Read Dynamic Variables And Loop Current
            self._hrt_frame_write.body = f"{hrt_data.get_variable('error_code')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('loop_current')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('unit_code')}"
            ...
            self._hrt_frame_write.body = f"{hrt_data.get_variable('error_code')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('polling_address')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('loop_current_mode')}"
        elif command == '08':  # Read Dynamic Variable Classifications
            self._hrt_frame_write.body = f"{hrt_data.get_variable('error_code')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('primary_variable_classification')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('secondary_variable_classification')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('tertiary_variable_classification')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('quaternary_variable_classification')}"
        elif command == '09':  # Read Device Variables with Status
            self._hrt_frame_write.body = f"{hrt_data.get_variable('error_code')}"
        elif command == '0A':  # (10)
            self._hrt_frame_write.body = f"{hrt_data.get_variable('error_code')}"
            ...
            self._hrt_frame_write.body += "FE"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('master_slave | manufacturer_id')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('device_type')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('request_preambles')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('hart_revision')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('software_revision')}"
            ...
            self._hrt_frame_write.body = f"{hrt_data.get_variable('error_code')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('message')}"
        elif command == '0D':  # Read Tag, Descriptor, Date (13)
            self._hrt_frame_write.body = f"{hrt_data.get_variable('error_code')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('tag')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('descriptor')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('date')}"
            ...
            self._hrt_frame_write.body = f"{hrt_data.get_variable('error_code')}"
            self._hrt_frame_write.body += f"{hrt_data.get_variable('final_assembly_number')}"
