...
mb_banco: Dict[str, Tuple[str, str, str, str]] = {
    ...
    'FI100CA': (4, 'FLOAT', 'ir', '01', '$[5.0],[10.0 1.0],MODBUS.CLP100.FV100CA/100'),
    'qCA'    : (4, 'FLOAT', 'ir', '03', '$[1.1E7],[20.0 1.0],MODBUS.CLP100.FI100CA/100'),    
    'FV100AR': (2, 'UNSIGNED', 'hr', '03', '0032'),    
    'FI100AR': (4, 'FLOAT', 'ir', '05', '$[0.15],[5.0 1.0],MODBUS.CLP100.FV100AR/100'), 
    'qAR'    : (4, 'FLOAT', 'ir', '07', '$[4.4E6],[20.0 1.0],MODBUS.CLP100.FI100AR/100'),        
    'TI100'  : (4, 'FLOAT', 'ir', '09', '$[5.0],[10.0 1.0],MODBUS.CLP100.qCA + MODBUS.CLP100.qAR'),    
    'FI100V' : (4, 'FLOAT', 'hr', '05', '3EA8F5C2'),
    'PI100V' : (4, 'FLOAT', 'ir', '11', '$[1.0],[1000 0.0000000001],(MODBUS.CLP100.qCA + MODBUS.CLP100.qAR) - 2770 * MODBUS.CLP100.FI100V'),
    'LI100'  : (4, 'FLOAT', 'ir', '13', '$[1.0],[1.1 0.0000000001],MODBUS.CLP100.FI100A - MODBUS.CLP100.FI100V'),    
    'PI100A' : (4, 'FLOAT', 'hr', '07', '43C80000'),    
    'FV100A' : (2, 'UNSIGNED', 'hr', '09', '0032'),    
    'FI100A' : (4, 'FLOAT', 'ir', '15', '$[0.3],[2.0 1.0],math.sqrt(MODBUS.CLP100.PI100A/400)*MODBUS.CLP100.FV100A'),
